...
import { z } from "zod";
import { Loader2, Eye, EyeOff, RefreshCw, X, Key } from "lucide-react";
...
interface InlinePasswordResetFormProps {
...
export const InlinePasswordResetForm: React.FC<InlinePasswordResetFormProps> = ({
  data,
  onSuccess,
  onCancel,
}) => {
