        ...
        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-2 !leading-[1.6] bg-gradient-to-r from-primary via-primary/80 to-chart-2 bg-clip-text text-transparent">
