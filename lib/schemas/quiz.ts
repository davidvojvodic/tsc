...
const matchingDataSchema = z.object({
  ...
  leftItems: z.array(matchingItemSchema).min(2, "At least 2 left items required").max(20, "Maximum 20 left items allowed"),
  rightItems: z.array(matchingItemSchema).min(2, "At least 2 right items required").max(20, "Maximum 20 right items allowed"),
